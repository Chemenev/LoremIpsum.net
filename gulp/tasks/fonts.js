import fs from 'fs'; // Плагин Node который работает с файловой системой
import fonter from 'gulp-fonter'; // Из otf в ttf и woff2
...
export const ttfToWoff = () => {
	...
	return app.gulp.src(`${app.path.srcFolder}/fonts/*.ttf`, {})
		...
		// Выгружаем в папку c результатами
...
export const fontsStyle = () => {
	...
	fs.readdir(app.path.build.fonts, function (err, fontsFiles) {
		if (fontsFiles) {
			// Проверяем существует ли файл для подключения шрифтов
